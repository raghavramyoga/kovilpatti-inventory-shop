...
export default function InventoryUserHome() {
      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-6 py-12">
        <div className="max-w-md w-full">
          <div className="landing-welcome-card text-center px-6 py-8 rounded-2xl bg-white">
            <h1 className="text-2xl font-bold uppercase tracking-wide text-[#1F1F1F] mb-2">Inventory Dashboard</h1>
            ...
            <p className="text-xs text-[#1F1F1F]/60 font-medium uppercase tracking-widest">
              Inventory User features coming soon
            </p>
          </div>
        </div>
      </main>
